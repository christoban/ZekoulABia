    ...
    <>
        ...
        <div className="bg-white/[0.06] border border-white/10 rounded-[8px] mb-2" style={{ padding: '8px 10px' }}>
          <div className="flex items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              <div className="text-[10.5px] text-white/35">{tcommon('brand.roleParent')}</div>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-white/[0.07]" style={{ padding: '8px 10px' }}>
        ...
        <div className="flex items-center gap-2.5 rounded-[8px] hover:bg-white/[0.06]" style={{ padding: '6px 8px' }}>
          <div className="w-7 h-7 rounded-[6px] bg-gradient-to-br from-[var(--amber)] to-[var(--orange)] flex items-center justify-center text-white font-black text-[11px] flex-shrink-0">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="text-[10px] text-white/35">{tcommon('user.parentFallback')}</div>
          </div>
          {onLogout && (
