  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in font-nunito">
      ...
      >
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className={`text-xs font-bold ${isPassed ? 'line-through' : ''}`} style={{ color: 'var(--text)' }}>
                          {item.title}
                        </p>
        ...
        {/* Footer */}
        <div className="p-4 border-t flex items-center justify-end" style={{ background: 'var(--surface2)', borderColor: 'var(--border)' }}>
          <button
            onClick={onClose}
            className="px-5 py-2 rounded-xl text-xs font-bold text-white border-none cursor-pointer"
