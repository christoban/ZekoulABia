...
const buttonStyle: React.CSSProperties = { width: '100%', padding: '14px 16px', border: 0, borderRadius: 12, background: 'linear-gradient(135deg,var(--green),var(--green2))', color: 'white', fontWeight: 800, fontSize: 15, transition: 'all 0.2s' }