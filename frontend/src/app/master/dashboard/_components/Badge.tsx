...
const STYLES: Record<BadgeType, string> = {
  ...
  active:       'bg-[var(--green-light)] text-[var(--green2)]',
  suspended:    'bg-[#fee2e2] text-[#991b1b]',
  rejected:     'bg-[#1a1a1a] text-[#e5e5e5]',
  'plan-deco':  'bg-[var(--green-light)] text-[#166534] border border-[#bbf7d0]',
  'plan-std':   'bg-[#eff6ff] text-[#1e40af] border border-[#bfdbfe]',
  'plan-prem':  'bg-[#ede9fe] text-[#5b21b6] border border-[#ddd6fe]',
  'event-success': 'bg-[var(--green-light)] text-[var(--green2)] font-mono',
